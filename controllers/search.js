...
exports.getSearchMethods = (req, res) => {
    const findOutput = findMethod(arr, 'Bauer');
    const filterOutput = filterMethod(arr, 'Bauer');
    const forEachOutput = forEachMethod(arr, 'Bauer');
    const forOutput = forMethod(arr, 'Bauer');
